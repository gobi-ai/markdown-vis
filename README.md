...
4. The visualization will be automatically generated by GitHub Actions when you commit markdown files
...
│   ├── api/
│   │   └── visualization/  # API route to get saved visualization
├── lib/
